...
console.log(`XOR(numberA, numberB): ${numberC.getHex()}`);
...
console.log('\nTask #2.3. Check the execution of the ADD operation');
...
console.log(`ADD(numberA, numberB): ${numberC.getHex()}`);
console.log('Comparison with the given answer:');
...
console.log('\nTask #2.3. Check the execution of the SUB operation');
...
console.log(`SUB(numberA, numberB) ${numberC.getHex()}`);
console.log('Comparison with the given answer:');
